  ...
  let onGetData = async () => {
    try {
      let response = await axios.get(
        `https://my-json-server.typicode.com/Winz05/Front-End-Dev/products/${productId.id}`
      );
    ...
    try {
      ...
      if (getTokenId) {
        ...
        let checkList = await axios.get(
          `https://my-json-server.typicode.com/Winz05/Front-End-Dev/cart?idProduct=${data.id}`
        );
        if (checkList.data.length === 0) {
          let response = await axios.post(
            "https://my-json-server.typicode.com/Winz05/Front-End-Dev/cart",
            dataToSend
          );
          ...
          let update = await axios.patch(
            `https://my-json-server.typicode.com/Winz05/Front-End-Dev/cart/${checkList.data[0].id}`,
